...
// ================================================
// SnakeGameClassic, snake_game_classic 치환 후 사용
// mbti_pro 프로덕션 패턴 기반
...
import 'package:snake_game_classic/app/theme/app_flex_theme.dart';
import 'package:snake_game_classic/app/translate/translate.dart';
...
Future<void> main() async {
  ...
  runApp(const SnakeGameClassicApp());
}

class SnakeGameClassicApp extends StatelessWidget {
  const SnakeGameClassicApp({super.key});
