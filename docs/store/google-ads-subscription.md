# 구글 플레이 콘솔 광고/결제 설정 가이드 (Snake Game Classic)

## 1. 현재 수익화 상태

| 항목 | 현재 상태 | 비고 |
| --- | --- | --- |
| 배너 광고 | 적용됨 | 홈 화면 하단 상시 노출, 게임 중 숨김 |
| 전면 광고 | 적용됨 | 게임 오버 직후 노출 |
| 보상형 광고 | 적용됨 | Neon/Fire 스킨 해제 시 선택적 시청 |
| 인앱 구매 | 미적용 | MVP 단계 비활성 |

## 2. 앱별 기준 정보

- 패키지명: `com.dangundad.snakegame`
- 플랫폼: Android 중심 운영
